...
public class ListBuku extends javax.swing.JFrame {
    ...
    public void loadData(){
        ...
        try {
            ...
            while (r.next()) {                
                ...
                p [2] = r.getString("Jenis");
                p [3] = r.getString("Halaman");
                p [4] = r.getString("Harga_Jual");
                p [5] = r.getString("Stok");
    ...
    private void btnPilihActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPilihActionPerformed
        ...
        TokoBuku.txIDBuku.setText(id);
        TokoBuku.txJudulBuku.setText(judul);
        TokoBuku.txHarga.setText(harga);
